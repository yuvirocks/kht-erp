...
.topbar-pill { background: rgba(0,0,0,.06); color: var(--label2); font-size: 11px; font-weight: 500; padding: 4px 10px; border-radius: 20px; }
.topbar-av { width: 30px; height: 30px; border-radius: 50%; background: var(--blue); display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; color: #fff; box-shadow: 0 2px 8px rgba(0,122,255,.30); }
...
.btn-navy    { background: rgba(0,0,0,.12); color: var(--label); border: none; }
...
.inp:focus, .sel:focus, .ta:focus { background: rgba(0,0,0,.07); box-shadow: 0 0 0 3px rgba(0,122,255,.18); }
...
.tbl th { text-align: left; font-size: 10.5px; font-weight: 600; color: var(--label3); letter-spacing: .06em; padding: 8px 12px; border-bottom: 0.5px solid rgba(0,0,0,.08); background: rgba(0,0,0,.02); text-transform: uppercase; }
...
.paste-area { border: 1.5px dashed rgba(0,122,255,.30); border-radius: var(--radius-sm); padding: 14px; background: rgba(0,122,255,.04); font-size: 13px; color: var(--label2); font-family: -apple-system, BlinkMacSystemFont, monospace; outline: none; resize: vertical; min-height: 100px; transition: border-color .15s; width: 100%; }
.paste-area:focus { border-color: var(--blue); }
.paste-area::placeholder { color: var(--label3); }
.num-badge { width: 22px; height: 22px; border-radius: 50%; background: var(--blue-l); color: var(--blue); display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; flex-shrink: 0; }
.action-btn { width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 11px 16px; border-radius: var(--radius-sm); font-size: 13px; font-weight: 600; cursor: pointer; border: none; font-family: -apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif; transition: all .15s; }
...
.print-topbar { background: rgba(255,255,255,.90); backdrop-filter: blur(24px); padding: 13px 22px; display: flex; align-items: center; justify-content: space-between; border-bottom: 0.5px solid rgba(0,0,0,.08); flex-shrink: 0; }
...
.notif { position: fixed; top: 16px; right: 16px; background: rgba(255,255,255,.90); backdrop-filter: blur(28px) saturate(180%); -webkit-backdrop-filter: blur(28px) saturate(180%); color: var(--label); padding: 10px 18px; border-radius: 14px; font-size: 13px; font-weight: 500; z-index: 99999; border: 0.5px solid rgba(0,0,0,.08); box-shadow: var(--shadow-lg); animation: slideIn .25s cubic-bezier(.34,1.56,.64,1); }
...
.avatar { width: 36px; height: 36px; border-radius: 50%; background: var(--blue); display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700; color: #fff; flex-shrink: 0; }
...
.prod-card { border-radius: var(--radius); overflow: hidden; background: var(--glass); cursor: pointer; border: 0.5px solid rgba(255,255,255,.9); box-shadow: var(--shadow-sm); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); transition: all .2s; }
...
.doc-split { display: flex; border-radius: var(--radius); overflow: hidden; height: calc(100vh - 140px); background: var(--glass); backdrop-filter: blur(24px); border: 0.5px solid rgba(255,255,255,.9); box-shadow: var(--shadow-sm); }
...
.ai-box { background: rgba(0,0,0,.04); border: 0.5px solid rgba(0,0,0,.08); border-radius: var(--radius-sm); padding: 14px; font-size: 13px; line-height: 1.7; color: var(--label); white-space: pre-wrap; min-height: 100px; }
...
.wa-btn { display: inline-flex; align-items: center; gap: 7px; background: var(--green-l); color: #1A8A3C; border: none; padding: 8px 16px; border-radius: var(--radius-sm); font-size: 13px; font-weight: 600; cursor: pointer; transition: all .15s; font-family: -apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif; }
.wa-btn:hover { background: rgba(52,199,89,.22); }

.divider { border: none; border-top: 0.5px solid rgba(0,0,0,.08); margin: 14px 0; }
.upload-z { border: 1.5px dashed rgba(0,122,255,.25); border-radius: var(--radius-sm); padding: 28px; text-align: center; cursor: pointer; transition: all .15s; background: rgba(0,0,0,.03); }
...
const DEFAULT_EXPORTS_WEBHOOK = ""; // Set this in Settings after deploying the Exports Apps Script
const EXPORTER_STATUS = ["New","Contacted","Interested","Negotiating","Sample Sent","Converted","Not Interested"];
const STATUS_COLOR = {
  "New":             { bg:"rgba(0,122,255,.12)",  text:"#007AFF" },
  "Contacted":       { bg:"rgba(255,149,0,.14)",  text:"#A05A00" },
  "Interested":      { bg:"rgba(52,199,89,.14)",  text:"#1A7A3A" },
  "Negotiating":     { bg:"rgba(175,82,222,.14)", text:"#7A2AAA" },
  "Sample Sent":     { bg:"rgba(90,200,250,.18)", text:"#006994" },
  "Converted":       { bg:"rgba(52,199,89,.22)",  text:"#0D5C28" },
...
export default function App() {
  ...
  const nav = [
    ...
    { id: "exports",   icon: "✈️",  label: "Exports",   section: "EXPORTS" },
  ];

  const titles = { home: "Dashboard Overview", dispatch: "Dispatch Manager", products: "Products Database", designer: "Picture Quotation", crm: "CRM & Sales", marketing: "Marketing Studio", documents: "Document Store", exports: "Exports · Global Importer Database" };
